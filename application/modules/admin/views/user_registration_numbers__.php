                ...
                if (!empty($user_info)) { 
                  ...
                  <tr>
                    ...
                    <td class="table-action text-center">
                      ...
                      |
                      <button type="button" class="btn btn-success btn-sm delete_Activity" link="<?php echo base_url(); ?>admin/User/deleteUser/<?php echo $row->id; ?>" data-toggle="modal" data-target="#myModalDelete"><i class="fa fa-trash tooltips" data-original-title="Delete User"></i> Delete</button>
                    </td>
                  </tr>
                  <?php
                  $i++;
