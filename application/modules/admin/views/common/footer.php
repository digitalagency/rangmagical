 <footer class="main-footer">
    <strong>Copyright © <?php echo date('Y ');?>Berger Paints Nepal.</strong>  All rights reserved.
  </footer>
...
<script type="text/javascript">
            $('document').ready(function() {
                ...
                tinymce.init({
                    ...
                    image_advtab: true,
                    relative_urls: false,
                    external_filemanager_path: "http://bergernepal.dev/" + "tinymce/file_manager/filemanager/",
                    filemanager_title: "Responsive Filemanager",
                    external_plugins: {"filemanager": "http://bergernepal.dev/" + "tinymce/file_manager/filemanager/plugin.min.js"}
                });
            });
        </script>
