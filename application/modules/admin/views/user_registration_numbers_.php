                ...
                if (!empty($user_info)) { 
                  ...
                  <tr>
                    ...
                    <td class="table-action text-center">
                      <?php echo base_url().'admin/User/deleteUser/'.$row->id.'/'.$this->uri->segment(2);?>
                      ...
                      |
                      <button type="button" class="btn btn-success btn-sm delete_Activity" link="<?php echo base_url(); ?>admin/User/deleteUser/<?php echo $row->id; ?>/<?php echo $this->uri->segment(2);?>" data-toggle="modal" data-target="#myModalDelete"><i class="fa fa-trash tooltips" data-original-title="Delete Activity"></i> Delete</button>
                    </td>
                  </tr>
                  <?php
                  $i++;
