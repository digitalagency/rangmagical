...
$(document).ready(function() {
  ...
  $("#addButton").click(function(e){ //on add input button click
    e.preventDefault();
    $(wrapper).append('<div class="col-md-3"><div class="form-group"><input name="couponumber[]" id="couponumber[]" type="text" class="form-control" placeholder=""maxlength="5" ></div></div>');
  });
});
</script>
        ...
        <div class="row">
          <div class="col-md-8 col-sm-12">
            ...
            <div class="introform">
              ...
              <div class="form-group">
                <label>Regd. No. :</label>
                <input type="text" class="form-control" placeholder="" required name="regno" id="regno" value="<?php if(isset($_POST['regno'])) echo $_POST['regno'];?>" maxlength="12" style="text-transform:uppercase">
              </div>
              <div class="form-group">
          ...
          <div class="contact-field clearfix">
            ...
            <div class="file-controls">
              <div class="container">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <input name="couponumber[]" id="couponumber[]" type="text" class="form-control" placeholder=""maxlength="7" value="<?php if(isset($_POST['couponumber'][$i])) echo $_POST['couponumber'][$i];?>" >
                  </div>
                </div>
                <?php } ?>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input name="houseimage" id="houseimage" type="file" required>
              </div>
